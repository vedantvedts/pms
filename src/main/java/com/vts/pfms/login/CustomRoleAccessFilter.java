...
//		
//		if(url[2].equalsIgnoreCase("wr") ||url[2].equalsIgnoreCase("login") || extension.stream().filter(e->ext.contains(e)).findAny().isPresent() || url[2].equalsIgnoreCase("welcome") || url[2].equalsIgnoreCase("MainDashBoard.htm")
