...
public class CustomRoleAccessFilter extends OncePerRequestFilter  {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(url[2].equalsIgnoreCase("login") || extension.stream().filter(e->ext.contains(e)).findAny().isPresent() || url[2].equalsIgnoreCase("welcome") || url[2].equalsIgnoreCase("MainDashBoard.htm")
