...
public class ProjectDaoImpl implements ProjectDao {
	...
	private static final String PROJECTRISKDATA ="SELECT am.actionmainid, am.actionitem, am.projectid, aas.actionstatus,am.type,aas.pdcorg,aas.enddate FROM action_main am ,action_assign aas WHERE aas.actionmainid=am.actionmainid AND aas.actionstatus IN ('A','I','C') AND am.type='K' AND am.actionmainid=:actionmainid";
