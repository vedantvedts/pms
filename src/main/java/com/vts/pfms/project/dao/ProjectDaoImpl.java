...
public class ProjectDaoImpl implements ProjectDao {
    ...
    private static final String PROJECTRISKDATALIST="SELECT am.actionmainid, am.actionitem, am.projectid, am.actionstatus,am.type,am.scheduleminutesId FROM action_main am , action_assign aas WHERE aas.actionmainid=am.actionmainid AND am.type='K' AND am.projectid=:projectid AND aas.assignorlabcode=:LabCode";  /* am.actionstatus IN ('A','I') AND */ 
	private static final String PROJECTRISKDATA ="SELECT am.actionmainid, am.actionitem, am.projectid, am.actionstatus,am.type,aas.pdcorg,aas.enddate FROM action_main am ,action_assign aas WHERE aas.actionmainid=am.actionmainid AND am.actionstatus IN ('A','I','C') AND am.type='K' AND am.actionmainid=:actionmainid";
