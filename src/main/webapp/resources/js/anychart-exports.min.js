...
(function (global, factory) { if (typeof module === 'object' && typeof module.exports === 'object') { var wrapper = function (w) { if (!w.document) { throw Error('AnyChart requires a window with a document'); } factory.call(w, w, w.document); try { w.acgraph.isNodeJS = Object.prototype.toString.call(global.process) == "[object process]"; } catch (e) { }; return w.anychart; }; module.exports = global.document ? wrapper(global) : wrapper; } else { factory.call(global, window, document) } })(typeof window !== 'undefined' ? window : this, function (window, document, opt_noGlobal) {
    var $, _, $_ = this.anychart; if ($_ && (_ = $_._)) { $ = $_.$ } else { throw Error('anychart-base.min.js module should be included first. See modules explanation at '); $ = {}; _ = {} } if (!_.exports) {
        _.exports = 1; (function ($) {
                        ...
                        $.Be(c.Sk).b.body.appendChild(c.ul); d = c.FA + "_inner"; e = LW(c.ul); if (window.document.baseURI) {
                            ...
                            try {
                                var u =
                                    ...
                                    } var y = v.fileName; null != y || (y = ""); if (/^http?:\/\//i.test(y)) { var B = HW(y); $.ke("view-source scheme plus HTTP/HTTPS URL"); var G = "view-source:" + GW(B); var D = $.ne(G) } else { var K = $.ke("sanitizedviewsrc"); D = $.ne(xW(K)) } var P = JW("Message: " + v.message + "\nUrl: "); u = { href: D, target: "_new" }; var R = v.fileName; if (!Jia.test("a")) throw Error("Invalid tag name <a>."); if ("A" in Kia) throw Error("Tag name <a> is not allowed for SafeHtml."); w = null; x = ""; if (u) for (var T in u) {
            ...
            $.hX = function (a) { return $.z(a.D) ? a.D : String(a.D) };
            dja = function (a, b, c) {
            ...
            var gia = /^(?:(?:http?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i, jia = /^[-,."'%_!# a-zA-Z0-9]+$/, Jia = /^[a-zA-Z0-9-]+$/, Lia = { action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0 }, Kia = { APPLET: !0, BASE: !0, EMBED: !0, IFRAME: !0, LINK: !0, MATH: !0, META: !0, OBJECT: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 }, nX = {
            ...
            uX.DE = function (a, b, c, d, e, f) {
                var h = uX.hc(a, "facebook"), k = MW({ caption: c, link: d, name: e, description: f }, c, h), l = $.ll.open("", "_blank", "scrollbars=yes, width=550, height=550, top=" + Number(window.screen.height / 2 - 275) + ", left=" + Number(window.screen.width / 2 - 275)); uX.Fu(a, b, function (a) {
                    a = { app_id: h.appId, display: "popup", picture: a }; a.caption = k.caption; k.link && (a.link = k.link, k.name && (a.name = k.name), k.description && (a.description = k.description)); var b = "", c; for (c in a) b += b ? "&" : "", b += c + "=" + a[c]; l.location.href = "" +
                        b
            ...
            uX.EE = function (a, b, c, d) { var e = uX.hc(a, "linkedin"), f = MW({ caption: c, description: d }, c, e), h = $.ll.open("", "_blank", "scrollbars=yes, width=550, height=520, top=" + Number(window.screen.height / 2 - 260) + ", left=" + Number(window.screen.width / 2 - 275)); uX.Fu(a, b, function (a) { a = { mini: "true", url: a }; a.title = f.caption; f.description && (a.summary = f.description); var b = "", c; for (c in a) b += b ? "&" : "", b += c + "=" + a[c]; h.location.href = "" + b }, void 0, !1, e.width, e.height) };
            uX.FE = function (a, b, c, d) { var e = uX.hc(a, "pinterest"), f = MW({ link: c, description: d }, c, e), h = $.ll.open("", "_blank", "scrollbars=yes, width=550, height=520, top=" + Number(window.screen.height / 2 - 260) + ", left=" + Number(window.screen.width / 2 - 275)); uX.Fu(a, b, function (a) { a = { media: a }; f.link && (a.url = f.link); f.description && (a.description = f.description); var b = "", c; for (c in a) b += b ? "&" : "", b += c + "=" + a[c]; h.location.href = "" + b }, void 0, !1, e.width, e.height) }; $.F("anychart.exports", uX);
