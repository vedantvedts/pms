...
b[1];return"Current scale ticks settings resulted in too many ticks: trying to generate about "+b[0]/c+" ticks with interval "+c;case 21:return"Data item with ID='"+b[0]+"' already exists. You should use another key.";case 22:return"Area "+b[0]+" not represented on screen.";default:return"Unknown error. Please, contact support team at /.\nWe will be very grateful for your report!"}};gl=function(a,b,c){var d=$.kl.console;d&&(a=d[a]||d.log,"object"!=typeof a&&a.call(d,b,c))};
wl=function(a,b){$.nd.call(this);this.g=a;this.K=b;this.Y=maa.test($.kl.location.hostname);this.F=!(this.K||this.Y);this.J=ll|ml|ul|vl};xl=function(){return("")+""};
...
text:"Exit full screen",action:function(a){a.chart.fullScreen(!1)}},about:{index:80,iconClass:"ac ac-cog",text:"AnyChart "+$.Aa.apply(null,["v%s.%s.%s.%s"].concat(["8","0","1","1726"])),href:""},"save-config-as":{index:100,text:"Save config as...",iconClass:"ac ac-save",subMenu:{"save-config-as-json":{index:10,text:".json",iconClass:"ac ac-file-code-o",eventType:"anychart.saveAsJson",action:function(a){a.chart.GF()}},"save-config-as-xml":{index:20,text:".xml",iconClass:"ac ac-file-code-o",
eventType:"anychart.saveAsXml",action:function(a){a.chart.HF()}}}},"link-to-help":{index:110,iconClass:"ac ac-question",text:"Need help? Go to support center!",href:""},"version-history":{index:120,text:"Version History",href:""}};
