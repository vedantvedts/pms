...
Cba=function(a,b){switch(a){case 1:return"Container is not set or can not be properly recognized. Use container() method to set it.";case 2:return"Scale is not set. Use scale() method to set it.";case 3:return"Table.contents() accepts only an Array of Arrays as it's first argument.";case 4:return'Feature "'+b[0]+'" is not supported in this module. See modules list at /Quick_Start/Modules for details.';case 5:return b[0]+" should be only "+b[1]+" type"+(b[2]?" ("+b[2]+").":
...
$.bl=function(a,b,c){var d=$.fl.console;d&&(a=d[a]||d.log,"object"!=typeof a&&a.call(d,b,c||""))};kl=function(a,b){$.od.call(this);this.f=a;this.N=b;this.ka=Eba.test($.fl.location.hostname);this.G=!(this.N||this.ka);this.Xb=gl|hl|il|jl};ll=function(){return("http:"==$.fl.location.protocol?"//":"http://")+""};nl=function(a){return ml()||a.ka};ol=function(){this.b={};this.g=$.kg();this.f=null};
...
c=a?this.AJ():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.De(this.g,{href:a?this.CJ():"utm_source=trial",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.De(this.b,{alt:a?this.BJ():"AnyChart - JavaScript Charts"}),this.I(hl));this.J(il)&&(a=a?this.text():"AnyChart Trial Version",$.ef(this.D,a),this.I(il));if(this.J(jl)){if(a=nl(this)?this.WE():ll()){if(this.O=a,b=uh($.kg()))$.Id(b,"complete",this.O2,!1,this),$.Id(b,
...
"full-screen-exit":{index:60,text:"Exit full screen",action:function(a){a.menuParent.fullScreen(!1)}},about:{index:80,iconClass:"ac ac-cog",text:"AnyChart "+$.hc.apply(null,["v%s.%s.%s.%s"].concat(["8","9","0","1932"])),href:""},"save-config-as":{index:100,text:"Save config as...",iconClass:"ac ac-save",subMenu:{"save-config-as-json":{index:10,text:".json",iconClass:"ac ac-file-code-o",eventType:"anychart.saveAsJson",action:function(a){a.menuParent.RN()}},"save-config-as-xml":{index:20,
text:".xml",iconClass:"ac ac-file-code-o",eventType:"anychart.saveAsXml",action:function(a){a.menuParent.SN()}}}},"link-to-help":{index:110,iconClass:"ac ac-question",text:"Need help? Go to support center!",href:""},"version-history":{index:120,text:"Version History",href:""}};
