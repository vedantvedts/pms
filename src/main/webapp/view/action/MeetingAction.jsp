...
<spring:url value="/resources/css/action/meetingAction.css" var="meetingAction" />
<link href="${meetingAction}" rel="stylesheet" />
							...
							<div class="col-md-8 div-right" >
					   			<form method="post" action="MeettingAction.htm" name="dateform" id="myform">
					   				<table>
					   					<tr>
					   						<td>
					   							<label class="control-label font-label" >Project: </label>
					   						</td>
					   						<td class="td-width300">
										...
										<%}} %>
											...
											<td>
					   							<label class="control-label font-label" >Committee: </label>
					   						</td>
					   						<td class="td-width300">
                                              <select class="form-control selectdee" id="committeeid" required="required" name="committeeid" onchange='submitForm();' >
					   						 ...
					   						 <td>
					   							<label class="control-label font-labe" >Meeting: </label>
					   						</td>
					   						<td class="td-width300">
                                                   <select class="form-control selectdee" id="meettingid" required="required" name="meettingid" onchange='submitForm();'>
											         ...
											         <option value="<%=obj[0]%>" <%if(obj[0].toString().equals(scheduleid)){ %>selected<%} %>><%= (obj[3] != null ? StringEscapeUtils.escapeHtml4(obj[3].toString())  : " - ") + " - " + meettingcount%>
</option>
											        <%meettingcount++;} }%>   
							  	                  </select>				   						
											</td> 	   									
											...
											<table class="table table-bordered table-hover table-striped table-condensed" id="myTable12" >
													...
													<thead>
														...
														<tr>
															<th>SN</th>
															<th>Action Id</th>	
															<th class="width-110px w-7" >PDC</th>
															<th >Action Item</th>																											 	
														 	<th >Assigner</th>
														 	<th >Progress</th>
															...
															if(meetinglist!=null && meetinglist.size()>0)
															{
																	...
																	<tr>
																		...
																		<td>
														                   ...
														                   <span class="custom-span" onclick="showAction('<%=obj[10].toString()%>','<%=obj[0].toString()%>')">show more..</span>
															               <%}else{ %>
															...
															<form name="myForm1" id="myForm1" action="ActionSubLaunch.htm" method="POST" 
                                                                  ...
                                                                  <%if(obj[8].toString().equalsIgnoreCase("A") || obj[8].toString().equalsIgnoreCase("B")|| obj[8].toString().equalsIgnoreCase("I")|| obj[8].toString().equalsIgnoreCase("K")){ %>
																	...
																	<%}if(obj[8].toString().equalsIgnoreCase("C")){ %>
																		<h5 class="custom-h5-one">Closed</h5>
																	<%}if(obj[8].toString().equalsIgnoreCase("F")){ %>
																		<h5 class="custom-h5-two">Forwarded</h5>
																	<%} %>
