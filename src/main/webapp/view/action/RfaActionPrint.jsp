        ...
        <table class="border-black" style="margin-top: 5px; margin-left: 3px; width: 700px">
           <tr>
		     <th colspan="10" style="font-size: 33px; height: 80px">Request For Action (RFA)</th>
              ...
              <tr>
                 <td colspan="2" style="text-align: center;border: 1px solid black; width: 20px;width: 83px"><img style="height: 2.5cm" src="data:image/png;base64,<%=lablogo!=null?lablogo:" - "%>"></td>
              ...
              <tr>
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 50px">&nbsp;&nbsp;Project : <span style="font-weight: normal;"><%=RfaPrint[2]!=null?RfaPrint[2].toString():" - "%> </span></td>
                <td colspan="4"style="border: 1px solid black; text-align: left; font-weight: 700; height: 50px">&nbsp;&nbsp;Classification : <span style="font-weight: normal;"><%=RfaPrint[6]!=null?RfaPrint[6].toString():" - " %> </span></td>
                <%for(Object[] obj : PriorityList){
                  if(obj[0].toString().equalsIgnoreCase(RfaPrint[5].toString())){%>
                <td colspan="4"style="border: 1px solid black; text-align: left; font-weight: 700; height: 50px">&nbsp;&nbsp;Priority : <span style="font-weight: normal;"><%=obj[1]!=null?obj[1].toString():" - " %> </span></td>
                <%}} %>
              </tr>
             ...
             <td colspan="6" style="border: 1px solid black; text-align: left; font-weight: 700; height: 50px">&nbsp;&nbsp;Rig Software Version : <span style="font-weight: normal;"><%=RfaPrint[26]!=null?   RfaPrint[26].toString():"-"%> </span></td>
              ...
              <tr>
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 30px ">&nbsp;&nbsp;Problem Statement  </td>
                 <td colspan="8" style="border: 1px solid black; text-align: justify; font-weight: 700;  width: 80px; "><span  style="font-weight: normal; padding:  3px 2px 2px 2px ;">&nbsp;&nbsp;<%=RfaPrint[7]!=null?RfaPrint[7].toString():" - " %></span></td>
              </tr> 
              <tr>
                <td colspan="2" style="border: 1px solid black;  font-weight: 700; text-align: left; height: 30px">&nbsp;&nbsp;Problem Description </td>
                 <td colspan="8" style="border: 1px solid black;  font-weight: 700;width: 80px; text-align: justify; "><span style="font-weight: normal;"><%=RfaPrint[8]!=null?RfaPrint[8].toString():" - " %></span></td>
              </tr> 
               <tr>
                 <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 30px">&nbsp;&nbsp;Reference </td>
                 <td colspan="8" style="border: 1px solid black; text-align: justify; font-weight: 700; "><span style="font-weight: normal; padding:  3px 2px 2px 2px;">&nbsp;&nbsp;<%=RfaPrint[9]!=null?RfaPrint[9].toString():" - " %></span></td>
              </tr> 
               <tr>
              ...
              %>
             <div >&nbsp;&nbsp;<%=ccList[0]!=null?ccList[0].toString():" - "%>,<%=desig!=null?desig:" - "%></div> 
              <%}}%>
              </td>
              </tr>
              ...
              <tr>
                ...
                <%if(RfaPrint[16]!=null){ %>
                <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 62px "><span style="font-weight: normal;">&nbsp;&nbsp;<%=raisedBy2!=null?raisedBy2:" - "%> <br>
                 <%if(RfaPrint[27]!=null) {%>  &nbsp;   <span > <%=RfaPrint[27].toString() %></span> <br><%} %>
                 <span style="font-size: 13px;"> &nbsp; [forwarded on :</span> <span class="spanDate"><%=risedDateFormatted!=null?risedDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                <%}else{ %>
             ...
             <%if(RfaPrint[17]!=null && Arrays.asList("AA","AF","AC","AV","AAA","AR","AP","ARC","RFA","AX","AY","AR","RR","AP","RP","REK").contains(RfaPrint[11]+"")){ %>
                 ...
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 62px "><span style="font-weight: normal;">&nbsp;&nbsp;<%=checkedBy2!=null?checkedBy2:" - "%> <br> <span style="font-size: 13px;"> &nbsp; [checked on :</span> <span class="spanDate"><%=checkedDateFormatted!=null?checkedDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                 <%}else{ %>
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700; height: 62px"><span style="font-weight: normal;"></span></td>
                  <%} %>
               <%}else{ %>
              ...
              <tr>
				<%if(RfaPrint[18]!=null && Arrays.asList("AV","AAA","AR","AP","ARC","RFA","AX","AY","RR","RP","REK","ARC").contains(RfaPrint[11]+"")){ %>
                 ...
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700; height: 64px"><span style="font-weight: normal;">&nbsp;&nbsp;<%=approvedBy2!=null?approvedBy2:" - "%> <br> <span style="font-size: 13px;"> &nbsp; [approved on :</span> <span class="spanDate"><%=approvedDateFormatted!=null?approvedDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                 <%}else{ %>
		     ...
		     <th colspan="10" style="font-size: 33px; height: 80px">Closure Report (RFA)</th>
              ...
              <tr>
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700;  ">&nbsp;&nbsp;Visual Inspection and <br>&nbsp;&nbsp;Observation </td>
                 <td colspan="8" style="border: 1px solid black; text-align: justify; font-weight: 700; height: 30px; width: 80px; height: 100px"><span style="font-weight: normal; padding:  3px 2px 2px 2px;">&nbsp;&nbsp;<%=RfaPrint[13]!=null?RfaPrint[13].toString():" - " %></span></td>
              </tr> 
              <tr>
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700;height: 30px">&nbsp;&nbsp;Clarification</td>
                 <td colspan="8" style="border: 1px solid black; text-align: justify; font-weight: 700;width: 80px; "><span style="font-weight: normal; padding:  3px 2px 2px 2px;">&nbsp;&nbsp;<%=RfaPrint[14]!=null?RfaPrint[14].toString():" - " %></span></td>
              </tr> 
               <tr>
                 <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 30px">&nbsp;&nbsp;Action Required</td>
                 <td colspan="8" style="border: 1px solid black; text-align: justify; font-weight: 700;"><span style="font-weight: normal; padding:  3px 2px 2px 2px;">&nbsp;&nbsp;<%=RfaPrint[15]!=null?RfaPrint[15].toString():" - " %></span></td>
              </tr> 
               <tr>
    
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 50px">&nbsp;&nbsp;Date of Completion </td>
                <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700; "><span style="font-weight: normal;">&nbsp;&nbsp;<%= RfaPrint[12]!=null ? new FormatConverter().SqlToRegularDate( RfaPrint[12].toString()): " - "%></span></td>
                    
              </tr> 
              <tr>
                <td colspan="2" style="border: 1px solid black; text-align: left; font-weight: 700; height: 62px">&nbsp;&nbsp;Prepared By </td>
                <%if(RfaPrint[19]!=null){ %>
                <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 62px "><span style="font-weight: normal;">&nbsp;&nbsp;<%=preparedBy2!=null?preparedBy2:" - "%> <br> <span style="font-size: 13px;"> &nbsp; [prepared on :</span> <span class="spanDate"><%=preparedByDateFormatted!=null?preparedByDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                <%}else{ %>
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 62px "><span style="font-weight: normal;"></span></td>
                <%} %>
              </tr> 
              ...
              <%if(RfaPrint[20]!=null && Arrays.asList("RFA","AR","ARC","AP").contains(RfaPrint[11].toString())){ %>
                 ...
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 62px "><span style="font-weight: normal;">&nbsp;&nbsp;<%=receivedBy2!=null?receivedBy2:" - "%> <br> <span style="font-size: 13px;"> &nbsp; [received on :</span> <span class="spanDate"><%=receivedBy2ByDateFormatted!=null?receivedBy2ByDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                 <%}else{ %>
                  <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700; height: 62px"><span style="font-weight: normal;"></span></td>
                 <%} %>
              <%}else{%>
              ...
              <%if(RfaPrint[21]!=null && Arrays.asList("AY","AP","ARC").contains(RfaPrint[11]+"")){ %>
                 ...
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700; height: 64px"><span style="font-weight: normal;">&nbsp;&nbsp;<%=approvedBy!=null?approvedBy:" - "%> <br> <span style="font-size: 13px;"> &nbsp; [approved on :</span> <span class="spanDate"><%=approvedByByDateFormatted!=null?approvedByByDateFormatted:" - "%></span><span style="font-size: 13px;"> ]</span></span></td>
                 <%}else{ %>
                 <td colspan="8" style="border: 1px solid black; text-align: left; font-weight: 700;height: 64px "><span style="font-weight: normal;"></span></td>
                 <%} %>
              <%}else{%>
