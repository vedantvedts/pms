				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>
						  ...
						  <div class="progress-bar primary" role="Allotment" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Capital : <%=CashOutGo.get(0)[3] %> Cr" ><%=CashOutGo.get(0)[3] %></div>
						  <% AllotCap=AllotCap.add(new BigDecimal( CashOutGo.get(0)[3].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Revenue : <%=CashOutGo.get(1)[3] %> Cr"  ><%=CashOutGo.get(1)[3] %></div>
						  <% AllotRev=AllotRev.add(new BigDecimal( CashOutGo.get(1)[3].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Others : <%=CashOutGo.get(2)[3] %> Cr"  ><%=CashOutGo.get(2)[3] %></div>
						  <% AllotOth=AllotOth.add(new BigDecimal( CashOutGo.get(2)[3].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Capital : <%=CashOutGo.get(0)[4] %> Cr"  ><%=CashOutGo.get(0)[4] %></div>
						  <% ExpCap=ExpCap.add(new BigDecimal( CashOutGo.get(0)[4].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Revenue : <%=CashOutGo.get(1)[4] %> Cr"  ><%=CashOutGo.get(1)[4] %></div>
						  <% ExpRev=ExpRev.add(new BigDecimal( CashOutGo.get(1)[4].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Others : <%=CashOutGo.get(2)[4] %> Cr"  ><%=CashOutGo.get(2)[4] %></div>
						  <% ExpOth=ExpOth.add(new BigDecimal( CashOutGo.get(2)[4].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Capital : <%=CashOutGo.get(0)[5] %> Cr"  ><%=CashOutGo.get(0)[5] %></div>
						  <% BalCap=BalCap.add(new BigDecimal( CashOutGo.get(0)[5].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Revenue : <%=CashOutGo.get(1)[5] %> Cr" ><%=CashOutGo.get(1)[5] %></div>
						  <% BalRev=BalRev.add(new BigDecimal( CashOutGo.get(1)[5].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[5] %> Cr" ><%=CashOutGo.get(2)[5] %></div>
						  <% BalOth=BalOth.add(new BigDecimal( CashOutGo.get(2)[5].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"  title="Project Capital : <%=CashOutGo.get(0)[6] %> Cr" ><%=CashOutGo.get(0)[6] %></div>
						  <% Q1Cap=Q1Cap.add(new BigDecimal( CashOutGo.get(0)[6].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Revenue : <%=CashOutGo.get(1)[6] %> Cr" ><%=CashOutGo.get(1)[6] %></div>
						  <% Q1Cap=Q1Cap.add(new BigDecimal( CashOutGo.get(1)[6].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[6] %> Cr" ><%=CashOutGo.get(2)[6] %></div>
						  <% Q1Cap=Q1Cap.add(new BigDecimal( CashOutGo.get(2)[6].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Capital : <%=CashOutGo.get(0)[7] %> Cr" ><%=CashOutGo.get(0)[7] %></div>
						  <% Q2Cap=Q2Cap.add(new BigDecimal( CashOutGo.get(0)[7].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Revenue : <%=CashOutGo.get(1)[7] %> Cr" ><%=CashOutGo.get(1)[7] %></div>
						  <% Q2Rev=Q2Rev.add(new BigDecimal( CashOutGo.get(1)[7].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[7] %> Cr" ><%=CashOutGo.get(2)[7] %></div>
						  <% Q2Oth=Q2Oth.add(new BigDecimal( CashOutGo.get(2)[7].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Capital : <%=CashOutGo.get(0)[8] %> Cr" ><%=CashOutGo.get(0)[8] %></div>
						  <% Q3Cap=Q3Cap.add(new BigDecimal( CashOutGo.get(0)[8].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Revenue : <%=CashOutGo.get(1)[8] %> Cr"  ><%=CashOutGo.get(1)[8] %></div>
						  <% Q3Rev=Q3Rev.add(new BigDecimal( CashOutGo.get(1)[8].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[8] %> Cr"  ><%=CashOutGo.get(2)[8] %></div>
						  <% Q3Oth=Q3Oth.add(new BigDecimal( CashOutGo.get(2)[8].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Project Capital : <%=CashOutGo.get(0)[9] %> Cr" ><%=CashOutGo.get(0)[9] %></div>
						  <% Q4Cap=Q4Cap.add(new BigDecimal( CashOutGo.get(0)[9].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Revenue : <%=CashOutGo.get(1)[9] %> Cr" ><%=CashOutGo.get(1)[9] %></div>
						  <% Q4Rev=Q4Rev.add(new BigDecimal( CashOutGo.get(1)[9].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[9] %> Cr" ><%=CashOutGo.get(2)[9] %></div>
						  <% Q4Oth=Q4Oth.add(new BigDecimal( CashOutGo.get(2)[9].toString())); %>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Capital : <%=CashOutGo.get(0)[10] %> Cr"  ><%=CashOutGo.get(0)[10] %></div>
						  <% AddlCap=AddlCap.add(new BigDecimal( CashOutGo.get(0)[10].toString())); %>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Revenue : <%=CashOutGo.get(1)[10] %> Cr" ><%=CashOutGo.get(1)[10] %></div>
						  <% AddlRev=AddlRev.add(new BigDecimal( CashOutGo.get(1)[10].toString())); %>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Project Others : <%=CashOutGo.get(2)[10] %> Cr" ><%=CashOutGo.get(2)[10] %></div>
				    ...
				    <tr>
				      ...
				      <td>
				      	<div class="progress cashoutgobar">
						  <div class="progress-bar primary" role="progressbar" style="width: 33%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Total Capital : <%=AllotCap %> Cr" ><%=ExpCap %></div>
						  <div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"title="Total Revenue : <%=AllotRev %> Cr" ><%=ExpRev %></div>
						  <div class="progress-bar bg-info" role="progressbar" style="width: 34%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" title="Total Others : <%=AllotRev %> Cr" ><%=ExpOth %></div>
						</div>
				      </td>
				      <td>
				      	<div class="progress cashoutgobar">
