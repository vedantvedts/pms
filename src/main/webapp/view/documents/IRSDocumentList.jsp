...
<%
    ...
    List<Object[]> irsDocumentList = (List<Object[]>) request.getAttribute("irsDocumentList");
    List<Object[]> irsDocumentSummaryList = (List<Object[]>)request.getAttribute("irsDocumentSummaryList");
	Object[] irsApproval=null;
	if(irsDocumentSummaryList!=null && irsDocumentSummaryList.size()>0){
		irsApproval=irsDocumentSummaryList.get(0);
	}
	
	String version = "1.0";
    version = irsDocumentList != null && irsDocumentList.size() > 0 ? irsDocumentList.get(0)[1].toString() : "1.0";
	    ...
	    <div class="col-md-12">
	        <div class="card shadow-nohover">
	            <div class="card-header">
	            	<form action="IRSDocumentList.htm" method="POST">
        				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		            	<div class="row">
		            		<div class="col-md-3">
		            			<h5 >IRS Document List</h5>
		            		</div>
	            ...
	            <div class="card-body">
	                <div class="col-md-12">
	                        ...
	                        <table class="table table-bordered table-hover table-striped table-condensed" id="myTable">
	                            ...
	                            <tbody>    
	                                <% if (irsDocumentList != null && irsDocumentList.size() > 0) {
	                                    int count = 0;
	                                    for (Object[] obj : irsDocumentList) {
	                                        count++;
	                                %>
	                                <tr>
	                                    ...
	                                    <td align="center" >
	                                   	...
	                                   	<td class="center">
										    <form action="#" method="POST" name="myfrm" style="display: inline">
										        ...
										        <%if(obj[5]!=null && irsforwardstatus.contains(obj[5].toString()) ) {%>
														
														<button type="submit" class="editable-clicko" formaction="IRSDocumentDetails.htm">
														...
														<%if(irsDocumentSummaryList!=null && irsDocumentSummaryList.size()>0) {%>
															<button type="submit" class="editable-clicko" formaction="IRSDocumentApprovalSubmit.htm" data-toggle="tooltip" data-placement="top" title="Forward" onclick="return confirm('Are You Sure To Forward this Document?');">
																<div class="cc-rockmenu">
																	<div class="rolling">
																		<figure class="rolling_icon">
													...
													<%if(obj[5]!=null && "RFW".equalsIgnoreCase(obj[5].toString()) ) {%>
														<button class="editable-clicko" name="revoke" formaction="IRSDocumentUserRevoke.htm" formmethod="post" onclick="return confirm('Are you sure to Revoke?')">
															<div class="cc-rockmenu">
																<div class="rolling">
																	<figure class="rolling_icon">
													...
													<%} %>
													<button class="editable-clicko" name="isPdf" value="Y" formaction="IRSDocumentDetails.htm" formtarget="blank" >
														<div class="cc-rockmenu">
															<div class="rolling">
																<figure class="rolling_icon">
	                    ...
	                    <%if(irsDocumentList!=null && irsDocumentList.size()==0) {%>
		                    <%-- <div style="margin-top: 20px; text-align: center;"> 
							    <form id="documentForm" action="IRSDocumentAdd.htm">
							...
							<div style="text-align: center;">
		                    	<form action="IRSDocumentAdd.htm" id="myform" method="post">
		                    		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		                        	...
		                        	<button class="btn btn-sm " type="submit" name="Action" id="addAction" value="Add" onclick="return confirm('Are You Sure to Create IRS Document?')" style="background-color: #428bca;border-color: #428bca;color: white;font-weight: bold;">Create IRS Doc v1</button>
		                 		</form>
		                    </div>
						<%} %>
	                </div>
	                ...
	                <div class="row mt-4">
	 					<div class="col-md-12" style="text-align: center;"><b>Approval Flow For IRS Doc</b></div>
	 	    		</div>
				...
				<div class="modal-header" style="background: #055C9D;color: white;">
     			...
     			<div class="modal-body">
     				<div class="container-fluid mt-3">
     					<form action="IRSDocumentAdd.htm" method="post">	
     						<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
     						<input type="hidden" name="projectType" value="<%=projectType %>">
                        	<input type="hidden" name="projectId"value="<%=projectId %>">
                        	<input type="hidden" name="initiationId" value="<%=initiationId %>">
                        	<input type="hidden" name="productTreeMainId" value="<%=productTreeMainId %>">
                        	<input type="hidden" name="irsDocId" id="irsDocId" value="0">
	                                ...
	                                <div class="form-inline mt-4">
	                                	<div class="form-group w-100 d-flex justify-content-center">
		                                    <button class="btn btn-sm " type="submit" name="Action" id="addAction" value="Add" onclick="return confirm('Are You Sure to Amend?')" style="background-color: #428bca;border-color: #428bca;color: white;font-weight: bold;">
						                        Create IRS Doc <span id="amendversiondisplay"></span>
						                    </button>
						            	</div>        
	                                </div>
								</div>
