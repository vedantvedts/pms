...
<title>
	<%if(docType!=null && docType.equalsIgnoreCase("A")) {%>
		IGI Doc
	<%} else if(docType!=null && docType.equalsIgnoreCase("B")) {%>
		ICD Doc
	<%} %>
	Status
</title>
	 ...
	 <div class="page card dashboard-card">
		 <div class="mt-2 mr-5" align="right">
			<form action="#">
				...
				<button type="submit" class="btn btn-sm btn-primary" formaction="IGIDocTransactionDownload.htm" formmethod="POST" formtarget="_blank" formnovalidate="formnovalidate"
