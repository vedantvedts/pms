	           			...
	           			<table align="center"  >
	        				<tr>
	        					<td class="trup" style="background: linear-gradient(to top, #3c96f7 10%, transparent 115%);">
	         						Prepared By - <%if(icdApproval!=null) {%><%=StringEscapeUtils.escapeHtml4(icdApproval[10].toString()) %> <%} else{%>Prepared By<%} %>
	         					</td>
	        					...
	        					<td class="trup" style="background: linear-gradient(to top, #eb76c3 10%, transparent 115%);">
	        						Reviewer - <%if(icdApproval!=null) {%><%=StringEscapeUtils.escapeHtml4(icdApproval[9].toString()) %> <%} else{%>Reviewer<%} %>
	        	    			</td>
	                    		...
	                    		<td rowspan="2">
	             				...
	             				<td class="trup" style="background: linear-gradient(to top, #9b999a 10%, transparent 115%);">
	             					Approver - <%if(icdApproval!=null) {%><%=StringEscapeUtils.escapeHtml4(icdApproval[8].toString()) %> <%} else{%>Approver<%} %>
	             	    		</td>
	            			</tr> 	
	            	    </table>			             
					</div>
