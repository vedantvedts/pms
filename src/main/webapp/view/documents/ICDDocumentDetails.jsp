...
<body <%if(isPdf!=null && isPdf.equalsIgnoreCase("Y")) {%> style="display:none;" <%} %>>
	...
	<%
		...
		for (Object[] connection : icdConnectionsList) {
		    ...
		    String value = connection[8].toString();
...
function DownloadDocPDF(){
	...
	var docDefinition = {
            content: [
                ...
                {
                    text: htmlToPdfmake('<h4 class="heading-color ">Interface Control Document (ICD) <br><br> FOR  <br><br>PROJECT <%=projectShortName %> </h4>'),
                    style: 'DocumentName',
                    alignment: 'center',
                    fontSize: 18,
                    margin: [0, 200, 0, 20]
