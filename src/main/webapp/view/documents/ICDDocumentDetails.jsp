                        ...
                        body: [
                            ...
                            <%if(dtoList!=null && dtoList.size()>0) {
	                    		...
	                    		[
	                                ...
	                                { text: '<%=pinmap.getLevelNameE1() %> (<%=pinmap.getLevelCodeE1() %>) - <%=pinmap.getPinNoE1() %>', style: 'tableData2', },
	                                { text: '<%=pinmap.getLevelNameE2() %> (<%=pinmap.getLevelCodeE2() %>) - <%=pinmap.getPinNoE2() %>', style: 'tableData2', },
