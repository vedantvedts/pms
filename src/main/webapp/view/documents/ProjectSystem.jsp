...
%>
				...
				<div class="card shadow-nohover" style="min-height: 34rem;">
					<form method="post" action="ProjectSystems.htm" id="myform">
						<div class="card-header">
							<div class="row">
								<div class="col-md-6">
									<h4 class="control-label">Documents</h4>
								</div>
												...
												<li><span class="caret" id="system<%=obj1[0]%>"
													onclick="doclist('<%=obj[0]%>','<%=obj[3] %>','<%=obj1[0]%>','<%=obj1[3] %>','-','','-','','-','',1,this)">
														...
														<button type="button" id="upbutton<%=obj1[0]%>"
															...
															<i class="fa fa-plus" style="color: #007bff"
																aria-hidden="true"></i>
														</button> <%-- <button type="button" class="btn"  style="background-color: transparent;margin: -5px -10px" onclick="batchdownload('<%=obj1[0]%>')">                                     
															<i class="fa fa-download" aria-hidden="true"></i>
														</button> --%>
												</span>
													<ul class="nested">
														...
														<li><span class="caret" id="system<%=obj2[0]%>"
															onclick="doclist('<%=obj[0]%>','<%=obj[3] %>','<%=obj1[0]%>','<%=obj1[3] %>','<%=obj2[0]%>','<%=obj2[3] %>','-','','-','',2,this)">
																...
																<button type="button" id="upbutton<%=obj2[0]%>"
																	...
																	<i class="fa fa-plus" style="color: #007bff"
																		aria-hidden="true"></i>
																</button> <%-- <button type="button" class="btn"  style="background-color: transparent;margin: -5px -10px" onclick="batchdownload('<%=obj2[0]%>')">                                     
																				<i class="fa fa-download" aria-hidden="true"></i>
																			</button> --%>
																...
																<li><span class="caret" id="system<%=obj3[0]%>"
																	onclick="doclist('<%=obj[0]%>','<%=obj[3] %>','<%=obj1[0]%>','<%=obj1[3] %>','<%=obj2[0]%>','<%=obj2[3] %>','<%=obj3[0]%>','<%=obj3[3] %>','-','',3,this)">
																		...
																		<button type="button" id="upbutton<%=obj3[0]%>"
																			...
																			<i class="fa fa-plus" style="color: #007bff;"
																				aria-hidden="true"></i>
																		</button> <%-- <button type="button" class="btn"  style="background-color: transparent;margin: -5px -10px" onclick="batchdownload('<%=obj3[0]%>')">                                     
																									<i class="fa fa-download" aria-hidden="true"></i>
																								</button> --%>
																</span>
																	<ul class="nested">
																		...
																		<li><span class="caret-last"
																			...
																			onclick="doclist('<%=obj[0]%>','<%=obj[3] %>','<%=obj1[0]%>','<%=obj1[3] %>','<%=obj2[0]%>','<%=obj2[3] %>','<%=obj3[0]%>','<%=obj3[3] %>','<%=obj4[0]%>','<%=obj4[3] %>',4,this)">
																				...
																				<button type="button" id="upbutton<%=obj4[0]%>"
																					...
																					<i class="fa fa-plus" style="color: #007bff"
																						aria-hidden="true"></i>
																				</button> <%-- <button type="button" class="btn"  style="background-color: transparent;margin: -5px -10px" onclick="batchdownload('<%=obj4[0]%>')">                                     
																														<i class="fa fa-download" aria-hidden="true"></i>
																													</button>  --%>
	...
	<form method="post" action="DocumentTempContent.htm" id="form1">
		<input type="hidden" name="projectid" value="<%=projectid %>" /> <input
			type="hidden" name="filerepmasterid" id="f1-filerepmasterid" value="" />
		<input type="hidden" name="fileuploadmasterid"
			id="f1-fileuploadmasterid" value="" /> <input type="hidden"
			name="systemids" id="f1-systemids" value="" /> <input type="hidden"
			name="docids" id="f1-docids" value="" /> <input type="hidden"
			name="headertext1" id="f1-headertext1" value="" /> <input
			type="hidden" name="headertext2" id="f1-headertext2" value="" /> <input
