...
<%
	...
	List<PfmsDocContentRev> contentlist=(List<PfmsDocContentRev>)request.getAttribute("contentlist");
		 ...
		 <h1 class="break"></h1> 
			<table class="index" style=" margin-top: 10px; margin-bottom: 10px; margin-left: 15px; max-width: 650px; min-width: 650px;font-size: 16px; border-collapse:collapse; width: 100%; "  >
				<tr>
					...
					<%	int count =1;
						for(PfmsDocContentRev item : contentlist)
						{ 
							...
							{ %>
								...
								<%	int count1=1;
									for(PfmsDocContentRev item1 : contentlist){ 
									...
									{ %>
										...
										<%	int count2=1;
											for(PfmsDocContentRev item2 : contentlist){ 
