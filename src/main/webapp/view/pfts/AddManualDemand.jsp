...
<spring:url value="/resources/css/pfts/AddManualDemand.css" var="holidayAddEdit" />     
             ...
             <form action="AddManualDemandSubmit.htm" method="post">
                   <div class="row">
		                 <div class="col-md-2">
		                      ...
		                      <span class="mandatory style3">*</span>
		                   </div>
		                    <div class="col-md-3">
		             ...
		             <div class="row">
		                 <div class="col-md-3">
		                    ...
		                    <div class="col-md-9 style5">
			                    <input type="text" class="form-control style6"  name="itemname" id="itemname"  required="required"  placeholder="Enter Item Name">		
		                   </div>
		             </div>
		             
		          <br>
		        <div class="form-group" align="center" >
					 <button type="submit" class="btn btn-primary btn-sm submit style7"  value="SUBMIT" id="manualAddBtn" onclick ="return confirm('Are you sure to submit?')">SUBMIT </button>
