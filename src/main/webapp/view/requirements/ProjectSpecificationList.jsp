			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-body">
	                      			...
	                      			<tr>
	                      				...
	                      				<td align="center" >
	                      					<form action="#" method="POST" name="myfrm" style="display: inline">
												...
												<%} %>
												<button class="editable-clicko" name="isPdf" value="Y" formaction="ProjectSpecificationDetails.htm" <%-- <%if(obj[9]!=null && ("RFA".equalsIgnoreCase(obj[9].toString()) ||  "RAM".equalsIgnoreCase(obj[9].toString()))) {%>formaction="SpecificationDownlodPdfFreeze.htm" <%}else {%> formaction="SpecificationdPdf.htm"  <%} %> --%>formtarget="blank" >
													<div class="cc-rockmenu">
														<div class="rolling">
															<figure class="rolling_icon">
	                    ...
	                    <%}else{ %>
	                     <div align="center">
	                         	<form action="SpecsTraceabilityMatrix.htm" id="myform21" method="post">
	                    		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
	                        	...
	                        	<input type="hidden" name="SpecsInitiationId" value="<%=initiationSpecList.get(0)[0].toString()%>">
	                 		</form>
	                 		</div>
	                     <%} %>
	              <div class="row">
		           			...
		           			<table align="center"  >
		        				<tr>
		        					<td class="trup" style="background: linear-gradient(to top, #3c96f7 10%, transparent 115%);">
		         						Prepared By - <%if(tempflow!=null && tempflow[0]!=null) {%><%=StringEscapeUtils.escapeHtml4(tempflow[0].toString()) %> <%} else{%>Prepared By<%} %>
		         					</td>
		        					...
		        					<td class="trup" style="background: linear-gradient(to top, #eb76c3 10%, transparent 115%);">
		        						Reviewer - <%if(tempflow!=null && tempflow[1]!=null) {%><%=StringEscapeUtils.escapeHtml4(tempflow[1].toString()) %> <%} else{%>Reviewer<%} %>
		        	    			</td>
		                    		...
		                    		<td rowspan="2">
		             				...
		             				<td class="trup" style="background: linear-gradient(to top, #9b999a 10%, transparent 115%);">
		             					Approver - <%if(tempflow!=null && tempflow[2]!=null) {%><%=StringEscapeUtils.escapeHtml4(tempflow[2].toString()) %> <%} else{%>Approver<%} %>
		             	    		</td>
		            			</tr> 	
		            	    </table>			             
						</div> 
						
							<form action="SpecificationAmendSubmit.htm" method="post">
					        <div class="container">
					            <!-- The Modal -->
					                        ...
					                        <div class="modal-content">
					                            ...
					                            <div class="modal-body">
					                                <div class="form-inline">
					                                    ...
					                                    <div class="form-group w-32" style="margin-left:-5px;">
					                            ...
					                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
					                            <input type="hidden" name="SpecsInitiationId" id="SpecsInitiationIdAmend">
					                            ...
					                            <div class="modal-footer" style="justify-content: center;">
					                                <button class="btn btn-sm " type="submit" name="Action" id="addAction" value="Add" onclick="return confirm('Are You Sure to Amend?')" style="background-color: #428bca;border-color: #428bca;color: white;font-weight: bold;">
					                                    Add Specification&nbsp; <span id="amendversiondisplay"></span>
					                                </button>
					                            </div>
					                        </div>
					                    </div>
...
<script>
    ...
    function setversiondata(version, SpecsInitiationId) {
        console.log(version);
        document.getElementById('currentversion').textContent = version;
        $('#SpecsInitiationIdAmend').val(SpecsInitiationId);
