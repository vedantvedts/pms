...
<link href="${contentCss}" rel="stylesheet" />
	...
	System.out.println("TestContentListjsp"+TestContentList);
					...
					<div class="row card-header"
						style="background: #C4DDFF; box-shadow: 2px 2px 2px grey;">
							     <div class="col-md-4" id="projecthead" align="left">
								      <h5 id="text" style="margin-left: 1%; font-weight: 600">System Sub System Test Plan</h5>
								 </div>
							     <div class="col-md-2">
								    ...
								    <div class="col-md-2">
								  	<form method="POST" action="ProjectTestPlan.htm">
								            <select class="form-control custom-select" id="projectType"  name="ProjectType" style=" margin-left: -85px; margin-top:-9px;">
 	                  ...
 	                  <div class="col-md-2" style="margin-left:6%;">
						<form class="form-inline" method="POST" action="ProjectTestPlan.htm">
							<div class="row W-100" style="width: 100%; margin-top: -3.5%;">
							 		...
							 		<select class="form-control selectdee" id="project"
										...
										for (Object[] obj : MainProjectList) {
										 String projectshortName1 = (obj[17] != null) ? " ( " + obj[17].toString() + " ) " : ""; %>
													<option value="<%=obj[0]%>"   <%if(projectId.equalsIgnoreCase(obj[0].toString())){ %>selected <%} %>>
							    ...
							    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> 
							    <input id="submit1" type="submit" name="submit" value="Submit" hidden="hidden">
						</form>
						</div>
				 <%}else{ %>
				  	<div class="col-md-2" style="margin-left:9%;">
						<form class="form-inline" method="POST" action="ProjectTestPlan.htm">
							...
							<label class="control-label"
								style="font-size: 15px; color: #07689f;"><b>Projects:</b></label>
							</div>
							<div class="col-md-3" style="" id="projectname">
					 		<select class="form-control selectdee" id="project"
								...
								for (Object[] obj : InitiationProjectList) {
								  %>
											<option value="<%=obj[0]%>"  <%if(initiationId.equalsIgnoreCase(obj[0].toString())){ %>selected <%} %> >
														<%=obj[4] %>
													</option>
								<%} }%>
								</select> 
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
   		...
   		<div class="modal-body">
	        ...
	        <%if(DocumentSummary!=null && DocumentSummary[4]!=null &&  reviewers.contains(obj[0].toString())){%>selected<%}%>>
    ...
    <div class="modal-content" style="width:137%;margin-left:-21%;">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
   		...
   		<%-- 	<div class="col-md-10">
   				<textarea required="required" name="TestApproach"
				class="form-control" id="" maxlength="4000"
				rows="3" cols="53" placeholder="Maximum 4000 Chararcters" required><%if(TestApproach!=null && TestApproach[0]!=null){%><%=TestApproach[0]%><%}else{%><%}%></textarea>
   			</div> --%>
   			</div>
   	<div class="mt-2" align="center">
   	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> 
