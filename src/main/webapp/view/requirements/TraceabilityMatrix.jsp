		...
		<div class="row">
			...
			<table class="table table-bordered">
					...
					%>
						...
						<td onmouseover="showContent('<%=obj[0].toString()%>')" onmouseout="hideContent('<%=obj[0].toString()%>')"><span class="viewbtn" ><%=obj[3]!=null?obj[3].toString(): " - " %></span>
						...
						%>
						<div class="RDiv" id ='<%=idCount+"R"+obj1[0].toString()%>' style="" onclick="showReqDiv('<%=idCount+"R"+obj1[0].toString()%>')"><%=obj1[1]!=null?obj1[1].toString(): " - " %></div>
			...
			<thead>
					...
					<td  ><%=objs[1]!=null?objs[1].toString(): " - " %></td>
					 <td  >
								...
								<% for(String s:paras){
								%>
							<div style="border: 1px solid #dee2e6"><%=s!=null?s: " - " %></div>
								<%} %>
