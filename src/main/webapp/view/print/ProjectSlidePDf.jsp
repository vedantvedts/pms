																...
																<div class="col left">
																	<table class="border-black" style="width: 98.1%;font-weight: bold;font-size: 1.25rem;margin-left:10px;">
																		<tr class="border-black" class="border-black">
																			<td  class="border-black" style="border-top: none;vertical-align: top;">
		...
		<div style="background-color: rgb(249, 242, 223);">
			...
			<div class="content" align="center" style="   border-radius: 5px !important;height:93vh !important;padding-top: 15px;">
				...
				<div class="firstpage"  > 
					...
					%>
					<h2 style="color: #145374 !important;text-align: center;"><%if( reviewedby!="" ) {%> <b> Review By Secretary DD(R&D) and Chairman DRDO </b> <%} %></h2>
												...
												<div >
													<div class="row" >
														<div class="col-md-12">
															...
															<table class="border-black" style="width: 99%;font-weight: bold;margin-left: 10px;margin-right: 10px;font-size: 14px;">
																<tr class="border-black">
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;width: 12%;">Project Code </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;width: 12%;">DoS </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;">PDC </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;width: 12%">User </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;width: 12%;">Category </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;">Cost / Exp (Cr) </td>
																	<td class="border-black" colspan="1" style="text-align:center;font-size: 14px; font-weight: bold; color: maroon;">Project Director </td>
																...
																<%-- <tr>
																	<td colspan="1"><b style="font-size: 14px; font-weight: bold; color: #021B79;">Scope : </b></td>
																	<td colspan="7"style="color: black;">
																			<%if(projects.get(i)[9]!=null) {%> 
																				<%=projects.get(i)[9]%> 
																			<%} else{%>
															...
															<div class="container-fluid" style="display: flex;">
																<div class="row" style="float: left;width: 50%;height: 100%;display: block;">
																	<div class="col" style="margin-left:10px">
																	<p>
															...
															<div style="float: right;width: 40%;align-content: center;margin-top: 5px;border:3px solid maroon;margin-right:10px;height:270px;padding:5px;"> 
															<%if(new File(filePath + projects.get(i)[25] + projects.get(i)[24]).exists()){%>
																	
																		<%if(new File(filePath + projects.get(i)[25] + projects.get(i)[27]).exists()){%>
																			<a  href="SlidePdfOpenAttachDownload.htm?slideId=<%=projects.get(i)[26]%>" target="_blank" >
																				<img class=" d-flex justify-content-center zoom2" data-enlargable style="height:265px; width: 100%; margin-bottom: 5px;margin: auto;" 
																				src="data:image/*;base64,<%=Base64.getEncoder().encodeToString(FileUtils.readFileToByteArray(new File(filePath + projects.get(i)[25] + projects.get(i)[24])))%>">
																			</a>
																		<%}else{ %>
																				<img class=" d-flex justify-content-center zoom2" data-enlargable style="height:265px;  width: 100%; margin-bottom: 5px;margin: auto;" 
												...
												<div >
													...
													<div class="row" style="">
														<div class="col-md-6" style="float: left;width: 50%;height: 100%;display: block;">
															<div class="row" style="">
																<div class="col left">
																	<table class="border-black" style="width: 98.1%;font-weight: bold;font-size: 14px;margin-left:10px;">
																		<tr class="border-black" class="border-black">
																			<td  class="border-black" style="border-top: none;vertical-align: top;">
																				<b style="font-size: 14px;font-weight: bold;color: #021B79;"> Brief:</b>
																			</td>
																		...
																		<%-- <tr>
																			<td>
																				<b style="font-size: 14px;font-weight: bold;color: #021B79;vertical-align: top;">Scope : </b>
																			</td>
																			<td colspan="3" style="color: black;"> 
																					<%=projects.get(i)[9]==null?"--":projects.get(i)[9]%> 
																			</td>
																	...
																	<div class="row">
																		<div class="col" style="margin-left:10px">
																			<p><span style="text-align: left;font-size: 14px; font-weight: bold; color: maroon;">
																				<u>Current Status </u>: 
																			</span>
																			<%if(projects.get(i)!=null && projects.get(i)[20]!=null) {%>
																				<%-- <%=projects.get(i)[20].toString().substring(3, projects.get(i)[20].toString().length())%> --%>
														...
														<br>
														<div class="col-md-6" style="float: right;width: 45%;align-content: center;margin-top: 5px;border:3px solid maroon;margin-right:10px;padding:5px;">
															
																			<%if(new File(filePath + projects.get(i)[25] + projects.get(i)[24]).exists()){%>
																				<%if(new File(filePath + projects.get(i)[25] + projects.get(i)[27]).exists()){%>
																				
																						<img  height="475" width="352" style=" max-width: 352px; display: block; margin: 0 auto;  width: 100%;" src="data:image/*;base64,<%=Base64.getEncoder().encodeToString(FileUtils.readFileToByteArray(new File(filePath + projects.get(i)[25] + projects.get(i)[24])))%>">
													...
													<div class="row" >
														<div class="col-md-12">
															...
															<table class="border-black" style="width: 99%;font-weight: bold;margin-left:10px ; margin-right:10px;font-size: 14px;">
																...
																<tr>
																	<td class="border-black" colspan="1" style="font-size: 14px; font-weight: bold; color: #021B79;">Brief :</td>
																	<td class="border-black" colspan="7" style="font-size: 14px;color: black;">
																		--
																	</td>
																</tr>
															...
															<%-- 	<tr>
																	<td colspan="1">
																		<b style="font-size: 14px; font-weight: bold; color: #021B79;">Scope : </b>
																	</td>
																	<td colspan="7" style="color: black;">
																		<%if (projects.get(i)[9] != null && projects.get(i)[9].toString().length() > 600) {%>
																			<%=projects.get(i)[9].toString().substring(0, 600)%>
															...
															<div class="row">
															<div class="col-2" style="margin-left:10px">
															<h4 style="text-align: left;font-size: 14px; font-weight: bold; color: maroon;">
																		<u>Current Status</u> : 
																	</h4>
															</div>
															<div class="col" style="margin-left:10px">
