...
<div style="text-align: right;margin-right:20px;">
	...
	<div class="heading-container" style="text-align: center; position: relative;"></div>
       <div style="text-align: center;font-family: <%= FontFamily %>;">
			...
			<table style="width: 650px;margin-left:10px; margin-top: 10px; margin-bottom: 5px;border:1px solid black;border-collapse: collapse;">
		      ...
		      <tr>
		          ...
		          <td align="center" class="text-dark" style="border:1px solid black;font-family: <%= FontFamily %>;"><span class="text-dark"></span><%=obj[1]!=null?obj[1].toString(): " - "%></td>
		          <td align="center" class="text-dark" style="border:1px solid black;font-family: <%= FontFamily %>;"><span class="text-dark"></span><%=obj[2]!=null?obj[2].toString(): " - "%></td>
       ...
       <div class="heading-container" style="text-align: center; position: relative;"></div>
         ...
         <tr>
                ...
                <td class="text-dark" style="font-family: <%= FontFamily %>;border: 1px solid black;padding-left: 10px;"><%= mlist[1]!=null?mlist[1].toString(): " - " %></td>
                <td class="text-dark" style="font-family: <%= FontFamily %>;border: 1px solid black; padding-left: 10px;"><%= mlist[2]!=null?mlist[2].toString(): " - " %></td>
                 <td class="text-dark"  style="font-family: <%= FontFamily %>;border: 1px solid black; padding-left: 10px;"><%= mlist[3]!=null?mlist[3].toString(): " - " %></td>
     ...
     <%}}%>
				...
				<tr>
					  <td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;text-align:left">1.&nbsp; Title: <span class="text-darks">Technical Project Closure Report  - <% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[12]!=null?DocumentSummary.get(0)[12].toString(): " - " %><%} %></span></td>
			   </tr>
			   
				<tr>
					<td class="text-darks" style="border:1px solid black;font-family: <%= FontFamily %>;">2.&nbsp; Type of Document:<span class="text-darks">Technical Closure Report for  <% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[12]!=null?DocumentSummary.get(0)[12].toString(): " - " %><%} %></span></td>
					<td class="text-darks" style="border:1px solid black;font-family: <%= FontFamily %>;">3.&nbsp; Classification: <span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[13]!=null?DocumentSummary.get(0)[13].toString(): " - " %><%} %></span></td>
			   </tr>
			   ...
			   <tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">8.&nbsp; Additional Information:<span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[0]!=null?DocumentSummary.get(0)[0].toString(): " - " %><%} %></span></td>
			   </tr>
			   
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">9.&nbsp; Project No & Name: <span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[11]!=null?DocumentSummary.get(0)[11].toString(): " - " %> - <%=DocumentSummary.get(0)[12]!=null?DocumentSummary.get(0)[12].toString(): " - " %><%} %> </span></td>
				</tr>
				
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">10.&nbsp; Abstract:<span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[1]!=null?DocumentSummary.get(0)[1].toString(): " - " %><%} %></span>
			   </tr>
			   
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">11.&nbsp; Keywords:<span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[2]!=null?DocumentSummary.get(0)[2].toString(): " - " %><%} %></span> </td>
				</tr>
				...
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">13.&nbsp; Distribution:<span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[3]!=null?DocumentSummary.get(0)[3].toString(): " - " %><%} %></span></td>
				</tr>
				...
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">15.&nbsp; Prepared by:<span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[10]!=null?DocumentSummary.get(0)[10].toString(): " - " %><%} %></span></td>
			   </tr>
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">16.&nbsp; Reviewed by: <span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[7]!=null?DocumentSummary.get(0)[7].toString(): " - " %><%} %></span> </td>
				</tr>
				
				<tr>
					<td  class="text-darks" colspan="2" style="border:1px solid black;font-family: <%= FontFamily %>;">17.&nbsp; Approved by: <span class="text-darks"><% if(DocumentSummary!=null && DocumentSummary.size()>0 ){%><%=DocumentSummary.get(0)[6]!=null?DocumentSummary.get(0)[6].toString(): " - "%><%} %></span> </td>
				</tr>
	...
	<h1 style="font-family: <%= FontFamily %>; font-size: <%= fontSize %>pt; font-weight: <%= HeaderFontWeight %>;" class="heading-colors">
                                 <%=++maincount%>.&nbsp;<%=obj[3]!=null?obj[3].toString(): " - " %>
                       </h1>
             <div>
				   <div style="margin-left: 10px;font-family: <%= FontFamily %>;font-size:<%=ParaFontSize%>pt;font-weight:<%=ParaFontWeight%>" >
					     <div style="text-align: justify;font-family: <%= FontFamily %>;font-weight:200;"><%if(obj[4]!=null) {%><%=obj[4].toString()%><%}%>
				...
				<% if(obj[3].toString().equalsIgnoreCase("APPENDICES")) { %>
			        ...
			        <tr>
			               <td class="text-dark" style="font-family: <%= FontFamily %>;border: 1px solid black;padding-left: 10px;"><%=i+++"."%></td>
			               <td class="text-dark" style="font-family: <%= FontFamily %>;border: 1px solid black;padding-left: 10px;"><% if(alist[1]!=null){ %><%=alist[1].toString() %><%}%></td>
			               <td class="text-dark" style="font-family: <%= FontFamily %>;border: 1px solid black; padding-left: 10px;"><% if(alist[2]!=null){ %><%=alist[2].toString()%><%}%></td>
			...
			for(Object[] obj1:Content){
				if(obj1[1].toString().equalsIgnoreCase(obj[0].toString())){ %>
					...
					&nbsp; <%=maincount%>. <%=++level1count%>&nbsp;<%=obj1[3]!=null?obj1[3].toString(): " - "%>
				       </h2>
             <div>
				   <div style="margin-left: 10px;font-family: <%= FontFamily %>;font-size:<%=ParaFontSize%>pt; text-align: justify;font-weight:<%=ParaFontWeight%>" >
					     <div style="text-align: justify;font-family: <%= FontFamily %>;font-weight:200;"><% if(obj1[4]!=null){%><%=obj1[4].toString()%><%} %></div>
					     }
					</div>
			...
			for(Object[] obj2:Content){
				if(obj2[1].toString().equalsIgnoreCase(obj1[0].toString())){ %>
			            ...
			            <h2 style="font-family: <%= FontFamily %>;margin-left: 10px;font-weight:<%=SubHeaderFontweight%>;font-size: <%= SubHeaderFontsize%>pt;"class="heading-colors">
					&nbsp; <%=maincount%>. <%=level1count%>. <%=++level2count%>&nbsp;<%=obj2[3]!=null?obj2[3].toString(): " - " %>
				       </h2>
             <div>
				   <div style="margin-left: 10px;font-family: <%= FontFamily %>;font-size:<%=ParaFontSize%>pt; text-align: justify;font-weight:<%=ParaFontWeight%>" >
					     <div style="text-align: justify;font-family: <%= FontFamily %>;font-weight:200;"><% if(obj2[4]!=null){%><%=obj2[4].toString() %><%} %></div>
					</div>
			</div>
