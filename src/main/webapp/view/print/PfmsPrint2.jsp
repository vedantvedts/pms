...
<table  style="margin-top:00px; margin-bottom: 0px;margin-left: 0px;width:717px; font-size: 15px;border-collapse: collapse;font-family:Gadugi ;" >
	...
	<tbody >
		...
		<tr>
				<th colspan="8" style="  text-align: center; padding: 0 5px 5px;font-size:28px"><%if(PfmsInitiationList[5]!=null){ %><br><%=PfmsInitiationList[5].toString() %><%}else{ %><i>Project Title</i><%} %>
			</th>
		</tr>
	
		<tr>
			<th colspan="8" style="  text-align: center; padding: 0 5px 5px;font-size:24px"><%if(PfmsInitiationList[4]!=null){ %>(<%=PfmsInitiationList[4].toString() %>)<%}else{ %><i> - </i><%} %>
			</th>
		</tr>
		...
		<tr>
			<th colspan="8" style="text-align: center; font-weight: 700;font-size: 22px"><br><%if(LabList[1]!=null){ %><%=LabList[1].toString() %><%}else{ %>-<%} %></th>
		</tr>
		...
		<tr>
			<th colspan="8" style="text-align: center; font-weight: 700;font-size:15px"><%if(LabList[2]!=null){ %><%=LabList[2].toString() %><%}else{ %> - <%} %></th>			
		</tr>
...
<table  class="brieftable executive" style="margin-top:10px; margin-bottom: 10px;margin-left: 35px;width:650px; font-size: 20px;border-collapse: collapse; ">
	<tbody>
		<tr>
			...
			<td  class="border_black weight_700 left" ><span ><%if(PfmsInitiationList[5]!=null){ %><%=PfmsInitiationList[5].toString() %><%}else{ %><i></i><%} %></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td  class="border_black weight_700 left" ><span ><%if(PfmsInitiationList[7]!=null){ %><%=PfmsInitiationList[7].toString() %> Months <%}else{ %><i></i><%} %></span></td>
		</tr>
		<tr>
			<th  class="border_black weight_700 left"> <span >Security Classification</span></th>
			<td  class="border_black weight_700 left" ><span ><%if(PfmsInitiationList[3]!=null){ %><%=PfmsInitiationList[3].toString() %><%}else{ %><i></i><%} %></span></td>
		</tr>
		<tr>
			<th  class="border_black weight_700 left"> <span >Whether Plan/Non-Plan</span></th>
			<td class="border_black weight_700 left" ><span ><%if(PfmsInitiationList[8]!=null){ if(PfmsInitiationList[8].toString().equalsIgnoreCase("P")){%> Plan <%}if(PfmsInitiationList[8].toString().equalsIgnoreCase("N")){ %>Non-Plan - <%if(PfmsInitiationList[14]!=null){ %> (Remarks : <%=PfmsInitiationList[14].toString()%> ) <%}else{ %> No  Remarks <%} %> <%}}else{ %><%} %></span></td>
		</tr> 
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[6]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[6].toString() %></td>
		<%}else{ %>
...
<tbody>
  ...
  <tr>
		<td style="font-size: 17px;  padding:10px; border-collapse:collapse; border:1px solid black;"><%=i+"." %></td>
 			 	<td style="font-size: 17px; padding:7px; border-collapse:collapse; border:1px solid black;"><%=obj[1]!=null?obj[1].toString(): " - " %></td>
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[12]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[12].toString() %></td>
		<%}else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" ><i class="normal">To be filled</i></td>
		<%} %>
		</tr>
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[1]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[1].toString() %></td>
		<%}else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" ><i class="normal">To be filled</i></td>
		<%} %>
		</tr>
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[2]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[2].toString() %></td>
		<%}else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" ><i class="normal">To be filled</i></td>
		<%} %>
		</tr>
...
<table  style="margin-top:00px; margin-bottom: 0px;margin-left: 0px;width:715px; font-size: 18px;border-collapse: collapse;font-family:Gadugi ;" >
	<tbody>
		...
		<%=PfmsInitiationList[11].toString() %></td>
		<%}
		else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px"><i class="normal">To be filled</i></td>
		<%}%>
...
<table  style="margin-top:10px; margin-bottom: 10px;margin-left: 0px;width:715px; font-size: 22px; ">
	<tbody>
		<tr>
			<td colspan="8" style="  text-align: left; padding: 0 5px 5px;font-size:20px" class="editor-text"><%if(obj1[3]!=null){%><%=obj1[3].toString()%><%}else{%>To be filled<%} %>
			</td>
		</tr>
	</tbody>
</table>
...
for(Object[] obj : DetailsList){   %>
		...
		<tbody>
			<tr>
			<%if(obj[4]!=null){  %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[4].toString() %></td>
			<%}else{ %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px"><i class="normal">To be filled</i></td>
			<%} %>
			</tr>
...
for(Object[] obj : DetailsList){   %>
		...
		<tbody>
			<tr>
			<%if(obj[5]!=null){  %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[5].toString() %></td>
			<%}else{ %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px"><i class="normal">To be filled</i></td>
			<%} %>
			</tr>
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[7]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[7].toString() %></td>
		<%}else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" ><i class="normal">To be filled</i></td>
		<%} %>
		</tr>
...
<%if(!DetailsList.isEmpty()){
	...
	%>
		...
		<tr>
		<%if(obj[8]!=null){  %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[8].toString() %></td>
		<%}else{ %>
		<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" ><i class="normal">To be filled</i></td>
		<%} %>
		</tr>
...
for(Object[] obj : DetailsList){   %>
		...
		<tbody>
			<tr>
			<%if(obj[9]!=null){  %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[9].toString() %></td>
			<%}else{ %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px"><i class="normal">To be filled</i></td>
			<%} %>
			</tr>
...
<%if(!ScheduleList.isEmpty()){ %>
	...
	<table  class="executive editor-text-font" style="margin-top:10px; margin-bottom: 10px;margin-left: 3px;width:707px;  ">
		...
		<td colspan="3" class="border_black weight_700 left" style="padding:5px;font-weight: 300;text-align:justify;" ><span ><%=obj[1]!=null?obj[1].toString(): " - " %></span></td>
		<td colspan="4" class="border_black  center" style="font-weight: 300"><%if(obj[5]!=null && obj[2]!=null){ %><%= "T"%><sub><%=obj[5].toString() %></sub><%="+"%><%=obj[2].toString()%><%}else{ %> - <%} %></td>
		<td colspan="2" class="border_black weight_700 center" style="font-weight: 300"><span ><%=obj[4]!=null?obj[4].toString(): " - "%></span></td>
		</tr> 
<%
count++;
}
		%>
			...
			<tr>
				<td colspan="12" class="border_black right" style=""  ><span ><b style="background: white; margin-right:190px;"><%if(obj[7]!=null && Integer.parseInt(obj[7].toString()) >0 ){ %>Total Duration :&nbsp;<%=obj[7].toString()+" Months" %></b ></span><%}%></td>
			</tr>
			<%} %>
</table>
...
for(Object[] obj : DetailsList){   %>
		...
		<tbody>
			<tr>
			<%if(obj[10]!=null){  %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px" class="editor-text"><%=obj[10].toString() %></td>
			<%}else{ %>
			<td colspan="8" style="text-align:justify; padding: 0 5px 5px;font-size:20px"><i class="normal">To be filled</i></td>
			<%} %>
			</tr>
