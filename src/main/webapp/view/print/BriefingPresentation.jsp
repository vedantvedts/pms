...
<div id="spinner" class="spinner" style="display:none;">
	<img data-enlargable  id="img-spinner" style="width: 200px;height: 200px;" src="view/images/spinner1.gif" alt="Loading"/>
</div>
						...
						for(int z=0;z<projectidlist.size();z++)
						{
							...
							<table class="subtables " style="align: left; margin-top: 10px; margin-bottom: 10px; margin-left: 25px;   border-collapse:collapse;" >
								<tr>
									...
									<td colspan="4" style=" width: 370px; padding: 5px; padding-left: 10px; font-weight: bold;color: #309322"> <%=projectattributes[1] %></td>
								</tr>
								<tr>
							...
							<div align="center">
								<table style="width: 100%;">
										...
										<tr>
											<td style="border:0;text-align: left;"> 
												<form action="ProjectDataSystemSpecsFileDownload.htm"  method="post" target="_blank" >	
													<span class="mainsubtitle">System Configuration &nbsp; </span><span class="anchorlink" onclick="$('#config<%=ProjectDetail.get(z)[0] %>').toggle();" style="color: #C84B31;cursor: pointer;" ><b>As on File Attached</b></span>
										...
										<tr>
											<td style="border:0;text-align: center ;">		
												<%if(FilenameUtils.getExtension(projectdatadetails.get(z)[3].toString()).equalsIgnoreCase("pdf")){ %>
													<iframe	width="1200" height="600" src="data:application/pdf;base64,<%=pdffiles.get(z)[0]%>"  id="config<%=ProjectDetail.get(z)[0] %>"  > </iframe>
												<%}else{ %>
													
													<img data-enlargable  style="max-width:25cm;max-height:17cm;" src="data:image/<%=FilenameUtils.getExtension(projectdatadetails.get(z)[3].toString()) %>;base64,<%=pdffiles.get(z)[0]%>"  id="config<%=ProjectDetail.get(z)[0] %>"  >
									...
									<%}else{ %>
										<tr>
											<td style="border:0;text-align: left;">		
												<span class="mainsubtitle">System Configuration. &nbsp; </span>File Not Found
											</td>
										</tr>
									<%} %>
								</table>
							...
							<div align="center">
								<table style="width: 100%;">
									<%if(projectdatadetails.get(z)!=null && projectdatadetails.get(z)[4]!=null){ %>
										<tr>
											<td style="border:0;text-align: left;"> 
												<form action="ProjectDataSystemSpecsFileDownload.htm"  method="post" target="_blank" >	
													...
													<span class="mainsubtitle"> System Specifications &nbsp; </span><span class="anchorlink" onclick="$('#sysspecs<%=ProjectDetail.get(z)[0] %>').toggle();" style="color: #C84B31;cursor: pointer;" ><b>As on File Attached</b></span>
													<!-- <button  type="submit" class="btn btn-sm "  ><i class="fa fa-download fa-lg" ></i></button> -->
													<input type="hidden" name="projectdataid" value="<%=projectdatadetails.get(z)[0]%>"/>
										...
										<tr>
											<td style="border:0;text-align: center ;"> 
												<%if(FilenameUtils.getExtension(projectdatadetails.get(z)[4].toString()).equalsIgnoreCase("pdf")){ %>
													<iframe	width="1200" height="600" src="data:application/pdf;base64,<%=pdffiles.get(z)[3]%>"  id="sysspecs<%=ProjectDetail.get(z)[0] %>"  > </iframe>
												<%}else{ %>
													<img data-enlargable  style="max-width:25cm;max-height:17cm;" src="data:image/<%=FilenameUtils.getExtension(projectdatadetails.get(z)[4].toString()) %>;base64,<%=pdffiles.get(z)[3]%>"  id="sysspecs<%=ProjectDetail.get(z)[0] %>"  > 											
												<%} %>
											</td>
										</tr>
										<%}else{ %>
										<tr>
											<td style="border:0;text-align: left;"> 
												<span class="mainsubtitle"> System Specifications File Not Found</span>
											</td>
										</tr>
										<%} %>
	...
	<!-- ---------------------------------------- P-3  Overall Product tree/WBS Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>3. Overall Product tree/WBS</h3> </div>
								...
								<tr>
									<td style="border:0; padding-left: 1.5rem;text-align: center ;"> 					
										<%if(FilenameUtils.getExtension(projectdatadetails.get(z)[5].toString()).equalsIgnoreCase("pdf")){ %>
											<iframe	width="1200" height="600" src="data:application/pdf;base64,<%=pdffiles.get(z)[1]%>"  id="protree<%=ProjectDetail.get(z)[0] %>"  > </iframe>
										<%}else{ %>
											
											
											<img data-enlargable   style="max-width:25cm;max-height:17cm;" src="data:image/<%=FilenameUtils.getExtension(projectdatadetails.get(z)[5].toString()) %>;base64,<%=pdffiles.get(z)[1]%>"  id="protree<%=ProjectDetail.get(z)[0] %>"  >
	...
	<!-- ---------------------------------------- P-4a  Particulars of Meeting Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>4 (a) <%if(committee.getCommitteeShortName().trim().equalsIgnoreCase("PMRC")){ %> 
															   						Approval 
															   						<%}else { %>
															   						Ratification
															   						<%} %>  of <b>recommendations</b> of last <%=committee.getCommitteeShortName().trim().toUpperCase() %> Meeting </h3> </div>
	...
	<!-- ---------------------------------------- P-4b Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header"><h4>4 (b) Last <%=committee.getCommitteeShortName().trim().toUpperCase() %>
														Meeting action points with Probable Date of completion (PDC), Actual Date of Completion (ADC) and status. </h4> </div>
	...
	<!-- ---------------------------------------- P-4c  Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>4 (c) Details of Technical/ User Reviews </h3> </div>
	...
	<!-- ---------------------------------------- P-5  Milestones achieved prior Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3> 5. Milestones achieved prior to this <%=committeeData.getCommitteeShortName().trim().toUpperCase() %> period.</h3></div>
	...
	<!-- ---------------------------------------- P-6b Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>6 (b) TRL table with TRL at sanction stage and current stage indicating overall PRI.</h3></div>
									...
									<%if(projectdatadetails.get(z)!=null && projectdatadetails.get(z)[6]!=null ){ %>
										<tr>
											...
											<td style="border:0;">
												...
												<%}else{ %>
													<img data-enlargable  style="max-width:25cm;max-height:17cm;" src="data:image/<%=FilenameUtils.getExtension(projectdatadetails.get(z)[6].toString()) %>;base64,<%=pdffiles.get(z)[2]%>"  id="pearl<%=ProjectDetail.get(z)[0] %>"  >											
												<%} %>
											</td>
										</tr>		
	...
	<!-- ---------------------------------------- P-6c Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>6 (c) Risk Matrix/Management Plan/Status.</h3></div>
	...
	<!-- ---------------------------------------- P-7  Details of Procurement Plan Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>7. Details of Procurement Plan (Major Items)</h3></div>
	...
	<!-- ---------------------------------------- P-8  Overall Financial Status Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>8. Overall Financial Status  <i style="text-decoration: underline;">(&#8377; Crore)</i> </h3></div>
	...
	<!-- ---------------------------------------- P-10  GANTT chart of overall project Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>10. GANTT chart of overall project schedule </h3></div>
	...
	<!-- ---------------------------------------- P-11 Issues Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>11. Issues </h3></div>
	...
	<!-- ---------------------------------------- P-12 Decision/Recommendations sought Div ----------------------------------------------------- -->
			...
			<div class="carousel-item ">
   				...
   				<div class="content-header" ><h3>12. Decision/Recommendations sought from <%=committeeData.getCommitteeShortName().trim().toUpperCase() %> </h3></div>
							...
							<form action="TechnicalWorkDataAdd.htm" method="post">
								<div class="row"align="center" >
									<div class="row" style="width:100%;margin-left: 0.5rem; margin-top: -0.5rem;">
										<div class="col-12">
											<div><%if(TechWorkDataList.get(z)!=null){ %> <%=TechWorkDataList.get(z)[2] %> <%}%></div>
										</div>	
									</div>
								</div>
											...
											%>
												...
												<%-- <% System.out.println(fileExt); %> --%>
													...
													<% }else{ %>
														...
														<img data-enlargable  style="max-width:25cm;max-height:17cm;" src="data:image/<%=fileExt%>;base64,<%=Base64.getEncoder().encodeToString(FileUtils.readFileToByteArray(techattachfile))%>"   >
	...
	<!-- ---------------------------------------- p-13c Technical Images Div ----------------------------------------------------- -->
			...
			<a class="carousel-control-next" href="#presentation-slides" role="button" data-slide="next" style="width:0%;padding-right: 20px; ">
				<span  aria-hidden="true" ><i class="fa fa-chevron-right fa-2x" style="color: #000000" aria-hidden="true"></i></span>
