...
<spring:url value="/resources/css/projectModule/projectApprovalRtmddo.css" var="projectApprovalRtmddo" />
<link href="${projectApprovalRtmddo}" rel="stylesheet" />
<title>PROJECT APPROVE P&C DO  LIST</title>
...
List<Object[]> ProjectApproveRtmddoList=(List<Object[]>) request.getAttribute("ProjectApproveRtmddoList");
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h4 class="cs-project">Project Approvals</h4>
			...
			<%if(ProjectApproveRtmddoList.size()>0){
				int count=1;
					for(Object[] obj:ProjectApproveRtmddoList){ %>
					      ...
					      <tbody>
						    		...
						    		<tr>
						    			...
						    			<label class="cs-label"> <b>&nbsp;Action :&nbsp;&nbsp;&nbsp;</b> </label>
						        			<select class="custom-select w-85" id="Category" required="required" name="Status" onchange="myconfirm(this,'myfrm<%=obj[5] %>')">
