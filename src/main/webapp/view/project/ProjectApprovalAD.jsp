...
<spring:url value="/resources/css/projectModule/projectApprovalAD.css" var="projectApprovalAD" />
<link href="${projectApprovalAD}" rel="stylesheet" />
					  ...
					  <table class="table table-bordered table-hover table-striped table-condensed ">
					      <tbody>
						    		...
						    		<tr>
						    			...
						    			<td><%if(obj[8]!=null && !obj[8].toString().equalsIgnoreCase("")){ %><%=StringEscapeUtils.escapeHtml4(obj[8].toString()) %>
						    			<%}else{ %>
						    			<%="-" %>
						    			<%} %>
						    		</tr>
