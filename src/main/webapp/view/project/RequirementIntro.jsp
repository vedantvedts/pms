	...
	<!-- 					<div class="panel panel-info" style="margin-top: 10px;">
						...
						<!-- 		<div class="panel panel-info" style="margin-top: 10px;">
							...
							<%-- 	<div class="panel panel-info" style="margin-top: 10px;">
								...
								<button class="btn bg-transparent buttonEd" type="button" id="btnEditor" onclick="showTable(<%=initiationid %>)" style="margin-top:-2%;"><i class="fa fa-eye" aria-hidden="true" style="color:dodgerblue"></i></button>
								</div>
								</div> --%>
					<!--  -->
					</div>
