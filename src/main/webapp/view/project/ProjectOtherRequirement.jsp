...
<nav class="navbar navbar-light bg-light justify-content-between"  style="margin-top: -1%">
		...
		<b style="color: #585858; font-size:19px;font-weight: bold;text-align: left; float:left" ><span style="color:#31708f">Additional Requirements for Project </span> <span style="color:#31708f;font-size: 19px"> <%=projectDetails[1]!=null?StringEscapeUtils.escapeHtml4(projectDetails[1].toString()): " - " %></span></b>
		</a>
		<form action="#">
...
<form action="AddProjectOtherReq.htm" method="POST">	         	  	
  ...
  <div class="modal-dialog modal-dialog-jump" role="document">
    ...
    <%for(Object[]obj:Otherrequirements){ %>
       ...
       <input name="ReqNames" type="hidden" value="<%=obj[1]!=null?StringEscapeUtils.escapeHtml4(obj[1].toString()): ""%>">
