...
<spring:url value="/resources/css/projectModule/intiationFlowAdd.css" var="intiationFlowAdd" />
<link href="${intiationFlowAdd}" rel="stylesheet" />
	...
	<div class="row">
		<div class="col-md-12">	
			...
			<div class="card shadow-nohover">	
					...
					<div class="col-md-2">
					<select class="form-control selectdee w-80" name="ApprovingOfficerLabCode" id="ApprovingOfficerLabCode" required="required"  onchange="chooseEmp()">
				...
				REVOKE</button>
				 <%} %> 
					<a class="btn btn-sm back" type="button" href="ProjectIntiationList.htm">BACK</a>
						...
						<% if(ApprovalData!=null ){%>
					<div align="center" class="cs-div-approve">
				<form action="#">
				<%
				   String colorCode = (String) ApprovalData[20];
				   String className = "C" + colorCode.replace("#", "").toUpperCase();
				%>
				<button type ="submit"  class="btn btn-sm btn-link w-100 btn-status fw-600 <%=className%>" formaction="InitiationFlowTrack.htm" value="<%=ApprovalData[0]%>" formtarget="_blank"  data-toggle="tooltip" data-placement="top" title="Transaction History" name="EnoteTrackId"> <%=ApprovalData[19].toString() %> 
				<i class="fa fa-external-link" aria-hidden="true"></i></button>
				</form>
				
				
				<form action="InitiationApprovalPrint.htm" target="_blank" class="ml-1p">
					<button type="submit" class="btn btn-sm edit cs-edit" data-toggle="tooltip" data-placement="top" title="Approval Print"><i class="fa fa-download cs-dwonload"></i></button>
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />     
