...
<spring:url value="/resources/css/projectModule/projectMasterRev.css" var="ExternalCSS" /> 
...
<div class="row">
  ...
  <div class="table-responsive">
	   <table class="table table-bordered table-hover table-striped table-condensed style2" >
  <thead>

<tr>
   <th>
 <label class="style3"> Project Main:
<span class="mandatory style4">*</span>
</label>
</th>
 <td>
  ...
  <th>
 <label class="style3"> Project Name:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<input type="text"   name="pname"  class="form-control alphanum-symbols-no-leading-space" value="<%=ProjectEditData[4]!=null?StringEscapeUtils.escapeHtml4(ProjectEditData[4].toString()): "S" %>" maxlength="255" required="required">
 ...
 <tr>
  <th>
 <label class="style3"> Project Number:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
  ...
  <th>
 <label class="style3"> Project Unit Code:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
...
<th>
 <label class="style3"> Project Code:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
 <input type="text"   name="pcode"
								class="form-control alphanum-symbols-no-leading-space" maxlength="20" value="<%=ProjectEditData[3]!=null?StringEscapeUtils.escapeHtml4(ProjectEditData[3].toString()): "" %>" required="required" readonly>
 
</td>

    <th>
<label class="style3"> Project Short Name:
<span class="mandatory style4">*</span>
</label>
</th>
<td>
...
<span class="mandatory style4">*</span>
 ...
 <td >
  ...
  <th>
 <label class="style3"> Project Director:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<select required="required" name="projectdirector" class="form-control form-control selectdee" id="officerPunchNo" data-width="100%" data-live-search="true">
    ...
    <tr>
  <th>
 <label class="style3"> Project Sanc Authority:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
  ...
  <th>
 <label class="style3"> Project Sanction No:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<input type="text"   name="sano"  value="<%=ProjectEditData[7] %>"
    ...
    <tr>
  <th>
 <label class="style3"> Project Sanction Date:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
...
<th>
 <label class="style3">Total Sanction Cost (&#8377;):
<span  class="mandatory style4">*</span>
</label>
</th>
 <td >
<input type="text" required="required"    id="totalcostid" name="tsancost"  class="form-control decimal-format" >
    ...
    <tr>
  <th>
 <label class="style3"> Board Of  Reference:
<span  class="mandatory style4">*</span>
</label>
</th>
 <td >
<%-- <input type="text"   name="bor" value="<%=ProjectEditData[15] %>"
  ...
  <th>
 <label class="style3"> Sanction Cost FE (&#8377;):
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<input type="text"   id="fecostid" name="sancostfe" value="<%=ProjectEditData[10]!=null?StringEscapeUtils.escapeHtml4(ProjectEditData[10].toString()): " - " %>"
...
<input  id="currentdate"  data-date-format="dd/mm/yyyy" readonly name="pdc" value="<%=sdf.format(ProjectEditData[12]) %>"
  ...
  <th>
 <label class="style3"> Sanction Cost RE (&#8377;):
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<input type="text"  name="sancostre" id="Recostid" value="<%=ProjectEditData[9]!=null?StringEscapeUtils.escapeHtml4(ProjectEditData[9].toString()): " - " %>"
    ...
    <tr>
    <th><label class="style3">
															Category: <span class="mandatory style4">*</span>
													</label></th>
  ...
  <th>
 <label class="style3">Security Classification:
<span class="mandatory style4">*</span>
</label>
</th>
 <td >
<select required="required" name="projectcategory" class="form-control form-control selectdee" id="selectbasic2" data-width="80%" data-live-search="true" >
 ...
 <!-- srikant code start -->
<tr>
<th><label class="style3">	Platform: <span  class="mandatory style4">*</span></label></th>
...
<!-- srikant code end-->
  <tr>
		<th colspan="1"><label class="style3">Nodal & Participating Lab:<span class="mandatory style4">*</span></label></th>
		<td colspan="3"><input required="required"	name="LabParticipating" class="form-control alphanum-symbols-no-leading-space" maxlength="5000" value="<%if(ProjectEditData[27]!=null ){%><%=StringEscapeUtils.escapeHtml4(ProjectEditData[27].toString()) %><%} %>" /></td>
</tr>
 <tr>
		<th colspan="1"><label class="style3">Application:<span class="mandatory style4">*</span></label></th>
...
<span class="mandatory style4">*</span>
 ...
 <td colspan="3">
  ...
  <tr>
  <th colspan="1">
 <label class="style3">Deliverable:
<span class="mandatory style4">*</span>
</label>
</th>
 <td colspan="3">
  ...
  <tr>
  <th colspan="1">
 <label class="style3">Remarks:
<span class="mandatory style4">*</span>
</label>
</th>
 <td colspan="3">
	<input  name="remarks" class="form-control alphanum-symbols-no-leading-space"  maxlength="500" required="required" value="<%if(ProjectEditData[32]!=null){%> <%=StringEscapeUtils.escapeHtml4(ProjectEditData[32].toString())%> <%}%>" >
</td>
 </tr>
