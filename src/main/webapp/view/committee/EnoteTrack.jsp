...
<spring:url value="/resources/css/committeeModule/EnoteTrack.css" var="EnoteTrack" />
<link href="${EnoteTrack}" rel="stylesheet" />
</head>
<body>
<%
		...
		%>
	      <article>
		  	<div class="inner">
				...
				%>
				<h2 class="<%=className%>"><%=extractedWord!=null?StringEscapeUtils.escapeHtml4(extractedWord):" - "%> at <%=object[4]!=null?time.format(object[4]):" - " %></h2> 
				<p class="custom-p">
