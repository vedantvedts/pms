...
<spring:url value="/resources/css/committeeModule/EmployeeReports.css" var="EmployeeReports" />
<link href="${EmployeeReports}" rel="stylesheet" />
				...
				<div class="card shadow-nohover">
					...
					<div class="row" >
						<div class="col-md-12">
							...
							<table class="mb-10px">
								<tr>
									<td class="border-0"><label class="control-label fs-17px mr-20px">Employee: </label></td>
					                <td class="border-0">
						   			...
						   			<td class="border-0"><label class="control-label fs-17px ml-10px mr-15px">Type: </label></td>
						            <td class="border-0">
						            	<select class="form-control select2 w-100" name="rtype" id="rtype" onchange="reportTypeChange();"  required="required">
							...
							<!-- --------------------------------------------- -->		
									...
									<td class = "daily border-0"><label class="control-label fs-17px margin0px-20px">Date: </label></td>
				                    <td class = "daily border-0">
							...
							<!-- --------------------------------------------- -->		
									...
									<td class = "weekly border-0"><label class="control-label fs-17px margin0px-10px">From: </label></td>
				                    <td class = "weekly border-0">
									...
									<td class = "weekly border-0"><label class="control-label fs-17px margin0px-10px">To:</label></td>
				                    <td class = "weekly border-0">
							...
							<!-- --------------------------------------------- -->		
									...
									<td class = "monthly border-0"><label class="control-label fs-17px margin0px-20px">Month: </label></td>
				                    <td class = "monthly border-0">
							...
							<!-- --------------------------------------------- -->
									<td class="border-0">
										<button type="submit" class="btn btn-sm btn-primary submit ml-10px">SUBMIT</button>
									</td>
						...
						<div class="row">
							...
							<div class="col-md-1">
								...
								<form method="post" action="EmployeeScheduleReportDownload.htm" target="_blank" > 
									<button type="submit" class="btn  btn-sm view bg-white">
...
<!-- ---------------------------------------------daily report ------------------------------------------- -->
					<% if(rtype.equalsIgnoreCase("D")){ %>						
						<div class="row">
							<div class="col-md-12">	
									<table class="tblDailyStyle">
										<tr>
											<th class="thDailyStyle">
												Time slot
											</th>
											<th class="text-center width-80rem">
												Meeting
											</th>
										</tr>
										<%
										...
										<tr>
											...
											<td class="pl-15px pt-5px pb-5px">
							...
							<div class="col-md-12">	
									...
									<table class="tblDailyStyle">
										<tr>
											...
											<th class="text-center thFromDataToDate">
										...
										<tr>
											...
											for(;fromdate1.isBefore(todate)||fromdate1.isEqual(todate);fromdate1=fromdate1.plusDays(1) ){ %>
											<td class="pl-15px pt-5px pb-5px wordWrapStyle">
...
<!-- --------------------------------------------- monthly report ------------------------------------------- -->
							...
							<div class="row">
								<div class="col-md-12">	
										<table class="tblDailyStyle">
											<tr>
												<th class="width-180px text-center">Sunday</th>
												<th class="width-180px text-center">Monday</th>
												<th class="width-180px text-center">Tuesday</th>
												<th class="width-180px text-center">Wednesday</th>
												<th class="width-180px text-center">Thursday</th>
												<th class="width-180px text-center">Friday</th>
												<th class="width-180px text-center">Saturday</th>
											</tr>
											<%int  temp=0,count=0;
											for(int j=1;j<7;j++){ %>
												<%if(temp<monthdays.size() ){ %>
												<tr class="height-120px">	
													<%for(int i=0;i<7;i++){ %>
														<td class="padding-5px text-center wordWrapStyle verticalAlignStyle"> 
