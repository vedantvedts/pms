...
<!-- -------------------------------------------------------members----------------------------- -->
	...
	<div align="center" >
		<div style="width: 650px;margin-left: 15px; font-size: 16px; " >
			...
			<div align="left" style="padding-right: 1.5rem;padding-bottom: 5rem;">
				...
				<br><%if(membersec!=null){%><%= StringEscapeUtils.escapeHtml4(membersec[6].toString()) %><%} %>
				<br>(Member Secretary)
			</div>
			</div>
			<%if(membersec!=null){ %>
			...
			<tbody>
				...
				while(actIterator.hasNext()){	
					...
					<tr>
						...
						<td  class="std" style="text-align: justify;"><%if( values.get(0)[5]!=null){ %> <%=sdf.format(sdf1.parse(StringEscapeUtils.escapeHtml4(values.get(0)[5].toString())))%> <%}else{ %> - <%} %></td>
					</tr>				
				<% } %>
			</tbody>
		</table>
	...
	<%}%>
							...
							<table style="margin-left:10px; width: 690px; margin-top:5px;font-size: 16px; border-collapse: collapse;border: 1px solid black" >
								...
								<b style="font-size: 12px;"><%=committeescheduleeditdata[8]!=null?StringEscapeUtils.escapeHtml4(committeescheduleeditdata[8].toString()): " - " +"/"+StringEscapeUtils.escapeHtml4(key)+"/"+obj[1]!=null?StringEscapeUtils.escapeHtml4(obj[1].toString()).split("/")[3]:" - " %></b>
								</td>
