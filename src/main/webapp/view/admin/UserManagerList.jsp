	...
	<div class="row">
		...
		<div class="col-md-12">
 		...
 		<h3 class="card-header">
			 ...
			 <a class="btn btn-info btn-sm shadow-nohover back" style="margin-left: 83%;"   href="MainDashBoard.htm">Back</a>
				</h3>
 					...
 					<div class="table-responsive">
	   					<table class="table table-bordered table-hover table-striped table-condensed "  id="myTable" > 
	    					...
	    					<tr>
	    						...
	    						<td><%=obj[2] %></td>
	     						<%-- <td><%=obj[3] %></td> --%>
	     					    <td style="text-align: center;"><%if(obj[4].equals("N")){%><span class="badge badge-warning">No</span><%}else{ %><span class="badge badge-success">Yes</span><%} %></td>
	     					    <td><%=obj[7] %></td>
	    					</tr>
	    						<%} %>
	    					</tbody>
