				...
				<div class="card shadow-nohover">
					<div class="card-header">
					 ...
					 <div class="col-lg-5"></div>
						<form class="form-inline " method="POST" action="${pageContext.request.contextPath}/IndividualNoticeList.htm">
						<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> 
				


				<label style="margin-left: 80px; margin-right: 20px; font-weight: 800">From Date:</label>
					<input  class="form-control form-control date"  data-date-format="dd-mm-yyyy" id="datepicker1" name="fdate"  required="required"  style="width: 120px;"
					 <%if(Fromdate!=null){%> value="<%=(Fromdate) %>" <%} %> >
					  
	
				<label style="margin-left: 20px; margin-right: 20px;font-weight: 800">To Date:</label>
				
					<input  class="form-control" data-date-format="dd-mm-yyyy" id="datepicker3" name="tdate"  style="width: 120px;" <%if(Todate!=null){%> value="<%=(Todate) %>" <%} %> >  
			                                        ...
			                                        %>
			                                            ...
			                                            <tr>
			                                               ...
			                                               <td style=" word-break: break-all;"><%=notiec[1]%></td>
															 ...
															 <form action="NoticeEditRevoke.htm" method="POST" name="myfrm"  style="display: inline" onsubmit="return confirm('Do you really want to Edit or Revoke');">
															<button  class="editable-click" name="sub" value="edit">
											                  ...
											                  <input type="hidden"  id="noticeId" name="noticeId" value="<%=notiec[0]%>"/>
															<input type="hidden" name="${_csrf.parameterName}"	value="${_csrf.token}" /> 
