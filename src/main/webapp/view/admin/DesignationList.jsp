	...
	<div class="row">
		...
		<div class="col-md-12">
 		...
 		<div class="card-header">
	 		<div class="row">
				<div class="col-md-10"><h3>Designation List</h3></div>
				<div class="col-md-2">		
			...
			<div class="card-body"> 
			<form action="DesignationEdit.htm" method="post" 	style="display: inline">
	   					...
	   					<table class="table table-bordered table-hover table-striped table-condensed "  id="myTable" > 
	    					...
	    					<tr>
	    						...
	    						<td>
										...
										<input type="hidden" name="desigid"	value="<%=obj[0] %>" />
...
<center> <a class="btn btn-info btn-sm  add"    href="DesignationAdd.htm">Add</a>    </center>
</div>
