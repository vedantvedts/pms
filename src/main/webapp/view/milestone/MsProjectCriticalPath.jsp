...
<%
	...
	List<Object[]> msCriticalPathList=(List<Object[]>)request.getAttribute("msCriticalPathList");
...
%>
	<div class="container-fluid mb-3">
		<div class="card shadow-nohover">
			...
			<div class="card-header" style="background-color: transparent;height: 3rem;">
 				<div class="row">
 					<div class="col-md-7">
 						<h3 class="text-dark" style="font-weight: bold;">Critical Paths - <%=projectDetails!=null?(projectDetails[3]!=null?StringEscapeUtils.escapeHtml4(projectDetails[3].toString()):" - "+" ("+projectDetails[1]!=null?StringEscapeUtils.escapeHtml4(projectDetails[1].toString()):" - "+")"):"" %> </h3>
 					</div>
	...
	<script>
		...
		function chartprint(type,interval){
			var data = [
				<%
				if(msCriticalPathList!=null && msCriticalPathList.size()>0) {
					int count=0; 
					for(Object[] level1 : msCriticalPathList){ 
				...
				%>
								    		  
						{
		                    ...
		                    children: [
		                    	<%
									int countA=0;
									for(Object[] level2 : msCriticalPathList){
								...
								%>
								
									{
					                    ...
					                    children: [
					                    	<%
												int countB=0;
												for(Object[] level3 : msCriticalPathList){
											...
											%>
												{
								                    ...
								                    children: [
								                    	<%
															int countC=0;
															for(Object[] level4 : msCriticalPathList){
														...
														%>
															{
											                    ...
											                    children: [
											                    	<%
																		int countD=0;
																		for(Object[] level5 : msCriticalPathList){  
	...
	<%-- <script>
			 ...
			 var filteredList = mstaskListJs.filter(item => item[16] === 1);
