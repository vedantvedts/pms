...
<link href="./resources/css/multiselect.css" rel="stylesheet"/>
  <spring:url value="/resources/css/fracasModule/fracasMainItemEdit.css" var="fracasMainItemEdit" />     
<link href="${fracasMainItemEdit}" rel="stylesheet" />
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<%if(fracasitemdata[7]!=null){ %>
											<button type="button" class="btn btn-sm dwnbutton"  onclick="submitForm('downloadfrm')" ><i class="fa fa-download"></i></button>
										<%} %>
										</label>
