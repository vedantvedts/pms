										           ...
										           <%=level1[3] %>
										             ...
										             <br>
										               ...
										               <div class="action-box-body" align="center" style="cursor: pointer ;" > 
													          ...
													          <div style="margin-top:-5px;"><i class="fa fa-caret-down" aria-hidden="true" style="font-size: 1.2rem;color:black;padding-top:2px;padding-bottom:0px;cursor: pointer ;"></i></div>
