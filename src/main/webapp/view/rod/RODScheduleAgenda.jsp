...
<div class="row">
 ...
 <form method="get" action="RODAgendaPriorityUpdate.htm" id="priority_form">
	<input type="hidden" name="scheduleid" value="<%=rodagendalist.get(0)[1]%>"/>
</form>
<%} %>  
